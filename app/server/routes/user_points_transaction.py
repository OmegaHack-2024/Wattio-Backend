...
from server.models.user_points_transaction import (
    UserPointsTransactionSchema,
    ResponseModel,
    ErrorResponseModel,
)
...
@router.post(
    "/", response_description="User points transaction data added into the database"
)
async def add_transaction_data(
    transaction: UserPointsTransactionSchema = Body(...),
